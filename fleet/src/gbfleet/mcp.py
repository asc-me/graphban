...
def read_status(client) -> tuple["matrix_mod.Profile | None", "matrix_mod.Policy", str,
    ...
    prints for a person — has any business with bands and probe suggestions. Capability cells
    (PRD-41) travel with the same payload and feed `resolve(..., capabilities=...)`.
    """
    try:
