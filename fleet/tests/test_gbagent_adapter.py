...
def test_the_id_the_server_returned_is_the_one_the_run_uses():
    ...
    agent_id, role, assigned, project = cli.register(_client(handler), code="WORKER-1", model="qwen",
    ...
    assert project == "", "a server that predates GRPH-719 names no project, and the client then names none"
