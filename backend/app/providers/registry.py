...
PROVIDERS: list[dict] = [
    # `serves` names what model type(s) this provider entry can serve: "chat", "embed",
    # "decide", or a comma-separated combination. `embeds` is derived from it for backward
    # compatibility with code that reads the boolean (GRPH-895).
    {"id": "stub", "label": "Offline stub", "kind": "stub", "serves": "chat,embed",
     "embeds": True,
     "base_url": "", "chat_model": "", "embed_model": "", "auth": False},
    {"id": "anthropic", "label": "Anthropic", "kind": "anthropic", "serves": "chat",
     "embeds": False,
     "base_url": "", "chat_model": "claude-opus-4-8", "embed_model": "", "auth": True},
    {"id": "openai", "label": "OpenAI", "kind": "openai", "serves": "chat,embed",
     "embeds": True,
     "base_url": "https://api.openai.com/v1", "chat_model": "gpt-4o-mini",
     "embed_model": "text-embedding-3-small", "auth": True},
    {"id": "gemini", "label": "Google Gemini", "kind": "openai", "serves": "chat,embed",
     "embeds": True,
     "base_url": "https://generativelanguage.googleapis.com/v1beta/openai",
     "chat_model": "gemini-2.0-flash", "embed_model": "text-embedding-004", "auth": True},
    {"id": "xai", "label": "xAI Grok", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "https://api.x.ai/v1", "chat_model": "grok-4.5",
     "models": ["grok-4.5", "grok-build-0.1"], "embed_model": "", "auth": True},
    {"id": "groq", "label": "Groq", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "https://api.groq.com/openai/v1", "chat_model": "llama-3.3-70b-versatile",
     "embed_model": "", "auth": True},
    {"id": "deepseek", "label": "DeepSeek", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "https://api.deepseek.com/v1", "chat_model": "deepseek-chat", "embed_model": "", "auth": True},
    {"id": "mistral", "label": "Mistral", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "https://api.mistral.ai/v1", "chat_model": "mistral-large-latest", "embed_model": "", "auth": True},
    {"id": "ollama", "label": "Ollama", "kind": "ollama", "serves": "chat,embed",
     "embeds": True,
    ...
    {"id": "openrouter", "label": "OpenRouter", "kind": "openai", "serves": "chat",
     ...
     "embed_model": "", "auth": True},
    {"id": "together", "label": "Together AI", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "https://api.together.xyz/v1", "chat_model": "deepseek-ai/DeepSeek-V3",
     "embed_model": "", "auth": True},
    {"id": "fireworks", "label": "Fireworks AI", "kind": "openai", "serves": "chat",
     "embeds": False,
     ...
     "embed_model": "", "auth": True},
    {"id": "perplexity", "label": "Perplexity", "kind": "openai", "serves": "chat",
     "embeds": False,
    ...
    {"id": "cohere", "label": "Cohere", "kind": "openai", "serves": "chat",
     "embeds": False,
    ...
    {"id": "custom", "label": "Custom (OpenAI-compat)", "kind": "openai", "serves": "chat",
     "embeds": False,
     "base_url": "", "chat_model": "", "embed_model": "", "auth": True},
    # GRPH-895 (PRD-45 S1). The third model type: a decider speaks /v1/systemone, not
    # /chat/completions. Two entries share the kind — one for a self-host laya box (no
    # default base_url; the operator names their host), one for TypeSafe's cloud (fixed
    # base_url, bearer auth, `chat_model` reused as the model/head name). `embeds` is
    # always false: a decider embeds nothing.
    {"id": "systemone", "label": "System One (self-host)", "kind": "systemone",
     "serves": "decide", "embeds": False,
     "base_url": "", "chat_model": "", "embed_model": "", "auth": True},
    {"id": "typesafe", "label": "TypeSafe AI", "kind": "systemone",
     "serves": "decide", "embeds": False,
     "base_url": "https://api.typesafe.ai", "chat_model": "jev-1.13.0",
     "embed_model": "", "auth": True},
]
...
def serves(pid: str) -> str:
    """What model type(s) this provider serves: 'chat', 'embed', 'decide', or a combo.

    Falls back to deriving from `embeds` for entries that predate the `serves` field.
    """
    p = _BY_ID.get(pid)
    if not p:
        return "chat"
    ...
    if s:
        return s
    return "chat,embed" if p.get("embeds") else "chat"


def serves_decide(pid: str) -> bool:
    """Whether this provider entry can serve as a decider (GRPH-895)."""
    return "decide" in serves(pid)
...
LISTS_MODELS = {p["id"] for p in PROVIDERS if p["kind"] in ("ollama", "openai", "systemone")}
